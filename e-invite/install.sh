...
setup_database() {
    ...
    print_success "Database 'einvite' created"
    print_success "User 'einvite' created with password: ${DB_PASSWORD}"
...
EOF
    ...
    npx tsx prisma/seed.ts || print_warn "Seed may have already been applied"
